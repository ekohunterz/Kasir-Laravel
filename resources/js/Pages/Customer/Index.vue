...
import Create from "@/Pages/Customer/Create.vue";
import Edit from "@/Pages/Customer/Edit.vue";
import Delete from "@/Pages/Customer/Delete.vue";
import DeleteBulk from "@/Pages/Customer/DeleteBulk.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("customer.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
...
const selectAll = (event) => {
    if (event.target.checked === false) {
        ...
        props.customers?.data.forEach((customer) => {
            data.selectedId.push(customer.id);
        });
    }
};
const select = () => {
    if (props.customers?.data.length == data.selectedId.length) {
                        ...
                        <template #table-body>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <Edit
                                            v-show="can(['customer update'])"
                                            :title="props.title"
                                            :customer="data.customer"
                                            @open="data.customer = customer"
                                        />
                                        <Delete
                                            v-show="can(['customer delete'])"
                                            :title="props.title"
                                            :customer="data.customer"
                                            @open="data.customer = customer"
                                        />
